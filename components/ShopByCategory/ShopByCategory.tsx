...
const ShopByCategory = () => {
  ...
  return (
    <section className="py-10 mx-auto px-8">
      <h2 className="text-2xl font-extrabold text-gray-800 mb-4">Shop by category</h2>
      <hr />
      <CategoryPills selectedCategory={selectedCategory} onCategorySelect={setSelectedCategory} />
      <hr />
